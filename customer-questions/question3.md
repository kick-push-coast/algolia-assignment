...
a. Using a connector to connect Algolia directly to a data source
b. Uploading data from a CSV or JSON file
c. Sending data directly to Algolia using an indexing API
d. Manually entering data into an index through the dashboard
